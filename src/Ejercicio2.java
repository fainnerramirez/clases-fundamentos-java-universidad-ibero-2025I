    ...
    public static void main(String[] args) {
        ...
        */
        ...
        do {
            ...
            if (option == 1) {
                System.out.println("Ingrese la cantidad a comprar del " + productOne + ": ");
                amountProductOne = sc.nextInt();
                System.out.println("Ingrese la cantidad a comprar del jugo " + productTwo + ": " );
                amountProductTwo = sc.nextInt();
                System.out.println("Ingrese la cantidad a comprar del empanadas " + productThree + ": ");
